...
class MsgSend PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_thorchain_5fbank_5ftx_2eproto);
    return ::descriptor_table_thorchain_5fbank_5ftx_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline void MsgSend::set_from_address(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:types.MsgSend.from_address)
}
inline void MsgSend::set_from_address(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:types.MsgSend.from_address)
}
inline void MsgSend::set_from_address(const void* value,
    size_t size) {
  
  from_address_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:types.MsgSend.from_address)
}
...
inline void MsgSend::set_to_address(std::string&& value) {
  ...
  to_address_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:types.MsgSend.to_address)
}
inline void MsgSend::set_to_address(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:types.MsgSend.to_address)
}
inline void MsgSend::set_to_address(const void* value,
    size_t size) {
  
  to_address_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:types.MsgSend.to_address)
}
