...
class PubKey PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_ethermint_5fkeys_2eproto);
    return ::descriptor_table_ethermint_5fkeys_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline void PubKey::set_key(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:ethermint.crypto.v1.ethsecp256k1.PubKey.key)
}
inline void PubKey::set_key(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  key_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:ethermint.crypto.v1.ethsecp256k1.PubKey.key)
}
inline void PubKey::set_key(const void* value,
  ...
  // @@protoc_insertion_point(field_set_pointer:ethermint.crypto.v1.ethsecp256k1.PubKey.key)
}
