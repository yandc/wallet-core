...
LDFLAGS = -fexceptions -s EXPORTED_FUNCTIONS='["_CppAddressCreateWithMiliKey", "_CppAddressIsValid", "_CppSignMili23", "_CppJsonTransactionMili23", "_TWStringSize", "_TWStringUTF8Bytes", "_TWStringDelete"]' -s EXPORTED_RUNTIME_METHODS='["ccall","cwrap"]'
